...
public class MultipleViewTypesFragmentTests {

    @Rule
    public FragmentTestRule<MultipleViewTypesFragment> fragmentTestRule = new FragmentTestRule<>(MultipleViewTypesFragment.class);
